...
const get_user_by_screenname = async (username) => {
...
const get_following_count_by_id = async (user_id) => {
    get_user_by_id_variables.userId = user_id
    const response = await axios.get(`${GET_USER_BY_ID}`, {
        params: {
            variables: JSON.stringify(get_user_by_id_variables),
...
module.exports = {
    ...
    GET_FOLLOWING_WEB_API_URL,
    get_user_features_stringify,
    get_user_by_screenname_variables,
    get_following_variables,
    get_user_by_screenname,
    get_following_api,
    get_following_count_by_id,
}